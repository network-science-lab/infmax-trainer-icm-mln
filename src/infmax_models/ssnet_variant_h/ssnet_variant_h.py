...
class SSNetVariantH(BaseHeteroModule):
    """
    Super Spreaders Network Variant H.
    ...
    def __init__(
        ...
        self.layerwise_encoder = Sequential(
            ...
            [
                ...
                (Dropout(p=0.2), "x_interim -> x_interim"),
                (
                    GCNConv(hidden_channels, hidden_channels // 2),
                    "x_interim, x_edges -> x_interim",
                ),
                ...
                (Dropout(p=0.2), "x_interim -> x_interim"),
                (
                    GCNConv(hidden_channels // 2, hidden_channels // 4),
                    "x_interim, x_edges -> x_interim",
                ),
